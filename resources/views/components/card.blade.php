<div id="card" class="w-96 bg-white rounded-xl gap-8  mt-32 flex justify-center flex-col items-center ">
    ...
    <h1 class="mt-20 font-bold text-4xl uppercase overflow-hidden">Lorem Ipsum</h1>
    <p class="text-center text-lg mx-12 font-medium">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Laboriosam
        mollitia
