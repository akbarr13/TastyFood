<footer class="bg-zinc-950 flex justify-between flex-col">

    <div class="mx-32 mt-32 flex flex-row h-3/4 ">
        <div id="left" class="w-1/4 flex gap-12 flex-col">
        ...
        <div id="left-middle" class="text-slate-50 w-1/4 pl-48 flex flex-col gap-12">
        ...
        <div id="right-middle" class="text-slate-50 w-1/4 pl-24 flex flex-col gap-12">
        ...
        <div id="right" class="text-slate-50 w-1/4  flex flex-col gap-12">
            <h1 class="text-3xl font-extrabold ml-4">Contact info</h1>
